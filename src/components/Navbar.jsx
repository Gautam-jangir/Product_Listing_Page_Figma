...
function Navbar() {
  return (
      <div className="flex justify-between items-center text-white px-[40px] pt-[62px]">
        <div className="flex justify-center items-center">
          <img className="w-12 h-12" src={logo} alt="FloraVision" />
          <span className="pl-4 hidden lg:block font-(family-name:--font-inter) text-3xl  font-black tracking-normal opacity-75">
            FloraVision.
          </span>
        </div>
        <div className="font-(family-name:--font-indie) hidden lg:block">
