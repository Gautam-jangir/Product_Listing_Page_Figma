...
function ResponsiveCard_2() {
  return (
    <div className="flex justify-center bg-[#1B2316] p-20">
      <div className="flex flex-col md:flex-row w-[512px] h-[644px] border-[1px] rounded-4xl relative backdrop-blur-[15px] bg-white/5">
...
export default ResponsiveCard_2;
