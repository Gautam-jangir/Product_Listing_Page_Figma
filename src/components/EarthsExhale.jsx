...
function EarthsExhale() {
  return (
    // <div className="flex lg:flex-row justify-center lg:justify-between">
    //   <div className="w-[802px] lg:max-w-[802px] lg:pl-[39px] pl-[0px] lg:ml-[0px] mt-[147px] flex flex-col items-center justify-center lg:items-start">
    //     <span className="font-semibold text-[clamp(59px,6vw,118px)] text-center lg:text-left  opacity-75">
    //       Earth's Exhale
    //     </span>
    ...
    //     </div>
    //   </div>
    //   <div className="hidden mr-[52px] w-[512px] h-[719px] lg:flex lg:justify-center lg:items-end mt-[95px]">
    //     <Card
